...
import com.dicoding.bangkit.android.fundamental.gitfind.adapter.followingFilterList
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val datafollowing = activity!!.intent.getParcelableExtra(EXTRA_DATA) as? Github
        getUserFollowing(datafollowing?.username.toString())
    }
    ...
    private fun showRecyclerListFollower() {
        ...
        val followingadapterdata = FollowingAdapter(followingFilterList)
        rvcarfollowing.adapter = followingAdapter

        followingadapterdata.setOnItemClickCallback(object : FollowingAdapter.OnItemClickCallback{
