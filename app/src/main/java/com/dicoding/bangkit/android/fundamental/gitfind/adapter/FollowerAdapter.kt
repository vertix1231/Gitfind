...
var followersFilterList = ArrayList<Github>()
class FollowerAdapter(private val list : ArrayList<Github>) : RecyclerView.Adapter<FollowerAdapter.FollowerViewHolder>() {

    init {
        followersFilterList = list
    }
